const projectDatas = [
  {
    ...
    projectContent:
      "Secure anonymization/de-anonymization library for protecting Personally Identifiable Information (PII) before sending data to Large Language Models (LLMs). Built with Rust for performance and safety, with bindings for Python and Node.js. Features comprehensive entity detection, deterministic UUID-based placeholders, and zero-copy deanonymization.",
  ...
  },
  {
    ...
    projectContent:
      "A lightweight, privacy-focused note-taking app with built-in AI assistance. Designed as a learning project, Thought Ink helps you take structured notes (with headings, bullet points, etc.), store them locally in your browser, and ask AI questions based on your content – all without sending your data to any server.",
    techStack: ["Typescript", "React.Js", "Node.Js", "Quill.Js", "Git"],
    projectLink:
      "https://github.com/gokul-viswanathan/note-taker?tab=readme-ov-file",
    show: "1",
  },
  {
    projectName: "LeanFrame: Efficient Video for ML",
    projectContent:
      "Trimmed the fat off video data—built a smart frame filter that sniffs out and drops redundant frames, making machine learning pipelines leaner and faster.",
  ...
  },
  {
    ...
    projectContent:
      "Built a price-tracking browser buddy that watches your wishlist like a hawk—no more site-hopping or falling for flashy recommendations. Just click, check, and chill till the price is right.",
  ...
  },
  {
    ...
    projectContent:
      "Simulated a human hand with realistic joint motion using MuJoCo—basically gave a robot a hand to wave, grasp, or even sign. It’s a digital playground for training complex hand movements (sign language was next on the list!).",
  ...
  },
  {
    ...
    projectContent:
      "Trained agents on OpenAI’s Cartpole and Mountain Car environments leveraging updated DQN and PPO algo- rithms, accomplishing rapid learning with minimal episodes.Demonstrated the A2C (Actor Critic) algorithm’s superior performance in training motion-related models in Gymna- sium’s Walker2D environment, outperforming other algorithms",
