const datas = [
  {
    ...
    active: "1",
    contents: [
      "Built an end-to-end medical document validator powered by Retrieval-Augmented Generation (RAG) and custom AI agents.",
      "Designed a pipeline that pulls validation rules and constraints directly from the database, ensuring accuracy and compliance.",
      "Implemented automated anonymization to strip sensitive patient information before any processing.",
      "Developed a “user-word → custom agent → rule-generation” flow that converts simple user instructions into complex validation logic.",
      "Added a smart fallback system: when validation fails, RAG analyzes the rule, one agent diagnoses the failure, and another agent generates a fix.",
      "Delivered a self-correcting validation engine that explains failures, learns from them, and produces clean, compliant output.",
    ],
  },
